...
```ts
import { weekday } from '@ngneat/falso';
...
// 2020-04-11T20:19:07.808Z
between({
  from: new Date(2020, 4, 4),
  to: new Date(2020, 5, 5),
});
```
...
```ts
import { soon } from '@ngneat/falso';

// 2022-01-13T20:19:07.808Z
soon({ days: 2 });
```
...
```ts
import { recent } from '@ngneat/falso';

// 2022-01-10T20:19:07.808Z
recent({ days: 2 });
```
...
```ts
import { future } from '@ngneat/falso';

// 2022-01-20T20:19:07.808Z
future({ years: 2 });
```
